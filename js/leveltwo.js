...
let nextLevel = "../levels/levelthree.html"
...
let enemies = [
    enemy = new Enemy(600, 125, 125, 125, "../sprites/enemies/cacos.gif", 75, "Cacos", 5, 15),
    enemy1 = new Enemy(600, 475, 125, 125, "../sprites/enemies/cacos.gif", 75, "Cacos", 5, 15),
    enemy2 = new Enemy(1200, 125, 125, 125, "../sprites/enemies/strongcacos.png", 125, "Cacos Fortes", 15, 30),
    enemy3 = new Enemy(1200, 475, 125, 125, "../sprites/enemies/strongcacos.png", 125, "Cacos Fortes", 15, 30),
]
// ----------------------------------------------------------------------------------------------------------------------------------
